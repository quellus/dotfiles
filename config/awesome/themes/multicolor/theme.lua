...
theme.wallpaper                                 = os.getenv("HOME") .. "/Pictures/wallpapers/MaterialThemeBackground.png"
theme.font                                      = "Noto Sans Regular 11"
theme.taglist_font                              = "Noto Sans Regular 12"
theme.menu_bg_normal                            = "#000000"
theme.menu_bg_focus                             = "#000000"
theme.bg_normal                                 = "#15222f"
theme.bg_focus                                  = "#2D3640"
theme.bg_urgent                                 = "#000000"
theme.fg_normal                                 = "#aaaaaa"
theme.fg_focus                                  = "#5488D1"
theme.fg_urgent                                 = "#af1d18"
theme.fg_minimize                               = "#ffffff"
theme.border_width                              = dpi(2)
theme.border_normal                             = "#000000"
theme.border_focus                              = "#5488D1"
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
	...
	style = {
	    ...
	    shape_border_color_focus = theme.border_normal,
	    align = "center",
	    spacing = 5,
	    fg_focus = fg_focus,
